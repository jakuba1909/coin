...
const string strMessageMagic = "Biotech Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    if (IsProofOfStake())
    {
        // biotech: coin stake tx earns reward instead of paying fee
        CAmount nCoinAge;
    ...
    // biotech: track money supply and mint amount info
