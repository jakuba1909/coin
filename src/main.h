...
static const int64_t MAX_SINGLE_TX = 30000000 * COIN; // 30 Million BCY coins
/** Future drift value */
...
inline int64_t MasternodeCollateral(int nHeight) { return 1500; } // 1500 BCY required as collateral
