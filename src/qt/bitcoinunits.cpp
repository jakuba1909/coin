...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BCY");
    case mBTC: return QString("mBCY");
    case uBTC: return QString::fromUtf8("μBCY");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BCYs");
    case mBTC: return QString("Milli-BCYs (1 / 1,000)");
    case uBTC: return QString("Micro-BCYs (1 / 1,000,000)");
    default: return QString("???");
    }
}
