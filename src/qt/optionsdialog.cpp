...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->anonymizeBiotech, OptionsModel::AnonymizeBiotechAmount);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting biotech."), QMessageBox::Ok);
