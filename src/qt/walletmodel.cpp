...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl *coinControl)
{
...

    {
        ...
        {
            emit message(tr("Send Coins"), tr("InstantX doesn't support sending values that high yet. Transactions are currently limited to %1 BCY.").arg(GetSporkValue(SPORK_5_MAX_VALUE)),
        ...
        {
            emit message(tr("Send Coins"), tr("IntantX doesn't support sending values that high yet. Transactions are currently limited to %1 BCY.").arg(GetSporkValue(SPORK_5_MAX_VALUE)),
                true, CClientUIInterface::MSG_ERROR);
            return IXTransactionCreationFailed;
        }
